...
{{
  ...
  "content_plan": [
    {{
      ...
      "group": "ประเภทกลุ่ม Facebook ที่ควรโพสต์ เช่น 'กลุ่มเจ้าของร้านเสริมสวย/ทำเล็บ/สปา ขนาด 5k-50k คน' พร้อมเหตุผลสั้นๆ",
  ...
  "founder_actions": ["action เจาะจงที่ Founder ต้องทำ — เรียงตามลำดับ พร้อมตัวอย่างข้อความ"],
  "ai_actions": [],
  "missing_info": [],
