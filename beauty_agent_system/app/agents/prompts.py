...
{
  "thinking": "1-2 ประโยคสั้นๆ บอกว่าคุณสังเกตเห็นอะไรในข้อมูลนี้ก่อนตอบ ภาษาไทยไม่เป็นทางการ เหมือนคิดออกเสียง เช่น 'เห็นสัญญาณลีดที่ Pain Point ชัดมาก น่าจะติดตามด่วน...'",
...
ห้ามใส่ key อื่นนอกจาก 7 ตัวนี้ ห้ามปล่อย key_findings ว่างเปล่าถ้าข้อมูลที่ได้รับเกี่ยวข้องกับหน้าที่ของคุณจริง
"""
